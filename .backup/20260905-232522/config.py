...
# Telegram app credentials (comma-separated id:hash pairs for rotation)
TELEGRAM_API_ID = _int("TELEGRAM_API_ID", 0)
TELEGRAM_API_HASH = _env("TELEGRAM_API_HASH", "")
TELEGRAM_API_CREDENTIALS = _env("TELEGRAM_API_CREDENTIALS", "")
AUTH_FAIL_BEFORE_BAD = _int("AUTH_FAIL_BEFORE_BAD", 2)
...
STINT_HARD_MULTIPLIER = _float("STINT_HARD_MULTIPLIER", 2.5)
DELAY_MESSAGES = _float("DELAY_MESSAGES", 1.0)
DELAY_CYCLES = _float("DELAY_CYCLES", 10)
MAX_ERRORS = _int("MAX_ERRORS", 13)
CONTACT_MAX_OFFLINE_DAYS = _int("CONTACT_MAX_OFFLINE_DAYS", 30)
CONTACT_ALL_MUTUAL = _env("CONTACT_ALL_MUTUAL", "1").lower() not in ("0", "false", "no", "")
...
SHADOW_SESSION_LIMIT = _int("SHADOW_SESSION_LIMIT", 8)
SHADOW_REST_SEC = _int("SHADOW_REST_SEC", 300)
SHADOW_REST_MAX_SEC = _int("SHADOW_REST_MAX_SEC", 900)
SHADOW_SKIP_CONTACT_STREAK = _int("SHADOW_SKIP_CONTACT_STREAK", 0)
SESSION_WARMUP_SENDS = _int("SESSION_WARMUP_SENDS", 5)
WARMUP_DELAY_MULTIPLIER = _float("WARMUP_DELAY_MULTIPLIER", 2.0)
ADAPTIVE_THROTTLE = _env("ADAPTIVE_THROTTLE", "1").lower() not in ("0", "false", "no", "")
ADAPTIVE_SHADOW_RATIO = _float("ADAPTIVE_SHADOW_RATIO", 0.2)
PARALLEL_CONTACTS_GROUPS = _env("PARALLEL_CONTACTS_GROUPS", "1").lower() not in ("0", "false", "no", "")
DELAY_MESSAGES_CONTACT = _float("DELAY_MESSAGES_CONTACT", 0.0)
MAINTENANCE_INTERVAL = _int("MAINTENANCE_INTERVAL", 300)
