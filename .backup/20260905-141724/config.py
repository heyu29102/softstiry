...
SHADOW_SKIP_CONTACT_STREAK = _int("SHADOW_SKIP_CONTACT_STREAK", 2)
SESSION_WARMUP_SENDS = _int("SESSION_WARMUP_SENDS", 8)
WARMUP_DELAY_MULTIPLIER = _float("WARMUP_DELAY_MULTIPLIER", 2.5)
ADAPTIVE_THROTTLE = _env("ADAPTIVE_THROTTLE", "1").lower() not in ("0", "false", "no", "")
ADAPTIVE_SHADOW_RATIO = _float("ADAPTIVE_SHADOW_RATIO", 0.2)
CONTACT_SEND_RATIO = _float("CONTACT_SEND_RATIO", 0.35)
