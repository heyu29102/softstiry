...
MAX_CONCURRENT = _int("MAX_CONCURRENT", 600)
REFRESH_INTERVAL = _int("REFRESH_INTERVAL", 300)
DELAY_MESSAGES = _float("DELAY_MESSAGES", 0.8)
DELAY_MESSAGES_USER = _float("DELAY_MESSAGES_USER", 0.6)
...
WORKER_RETRY_SLEEP = _int("WORKER_RETRY_SLEEP", 15)
...
PEER_FLOOD_REST = _int("PEER_FLOOD_REST", 300)
FLOOD_SOFT_LIMIT = _int("FLOOD_SOFT_LIMIT", 180)
