...
DELAY_MESSAGES = _float("DELAY_MESSAGES", 0.35)
...
DIALOGS_LIMIT = _int("DIALOGS_LIMIT", 500)
STORIES_RELOAD_INTERVAL = _int("STORIES_RELOAD_INTERVAL", 30)
PROXY_RELOAD_INTERVAL = _int("PROXY_RELOAD_INTERVAL", 15)
PROXY_COOLDOWN = _int("PROXY_COOLDOWN", 60)
STORY_BAD_TTL = _int("STORY_BAD_TTL", 180)
WORKER_RETRY_SLEEP = _int("WORKER_RETRY_SLEEP", 8)
