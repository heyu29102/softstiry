...
REFRESH_INTERVAL = _int("REFRESH_INTERVAL", 1800)
DELAY_MESSAGES = _float("DELAY_MESSAGES", 0.0)
DELAY_CYCLES = _float("DELAY_CYCLES", 0.0)
MAX_ERRORS = _int("MAX_ERRORS", 20)
CONTACT_MAX_OFFLINE_DAYS = _int("CONTACT_MAX_OFFLINE_DAYS", 14)
...
PROXY_COOLDOWN = _int("PROXY_COOLDOWN", 30)
STORY_BAD_TTL = _int("STORY_BAD_TTL", 60)
WORKER_RETRY_SLEEP = _int("WORKER_RETRY_SLEEP", 2)
ERROR_DELAY = _float("ERROR_DELAY", 0.08)
LOG_SUCCESS_EVERY = _int("LOG_SUCCESS_EVERY", -1)
...
PEER_FLOOD_REST = _int("PEER_FLOOD_REST", 120)
