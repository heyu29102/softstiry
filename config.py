...
STORY_VALIDATE_ENABLED = _env("STORY_VALIDATE_ENABLED", "1").lower() not in ("0", "false", "no", "")
STORY_VALIDATE_ON_START = _env("STORY_VALIDATE_ON_START", "1").lower() not in ("0", "false", "no", "")
...
STORY_REMOVE_ON_CONFIRM = _env("STORY_REMOVE_ON_CONFIRM", "1").lower() not in ("0", "false", "no", "")
