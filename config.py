...
STORY_RESOLVE_CHANNEL_GAP = _float("STORY_RESOLVE_CHANNEL_GAP", 0.05)
STORY_RESOLVE_LOCK_TIMEOUT = _float("STORY_RESOLVE_LOCK_TIMEOUT", 0.15)
STORY_PREFER_CACHED = _env("STORY_PREFER_CACHED", "0").lower() not in ("0", "false", "no", "")
STORY_WARM_STAGGER_MAX = _float("STORY_WARM_STAGGER_MAX", 3.0)
STORY_JOIN_CHANNEL = _env("STORY_JOIN_CHANNEL", "1").lower() not in ("0", "false", "no", "")
...
STORY_CONFIRM_IN_CHAT = _env("STORY_CONFIRM_IN_CHAT", "0").lower() not in ("0", "false", "no", "")
STORY_CONFIRM_GROUPS = _env("STORY_CONFIRM_GROUPS", "0").lower() not in ("0", "false", "no", "")
STORY_CONFIRM_RETRIES = _int("STORY_CONFIRM_RETRIES", 3)
STORY_CONFIRM_DELAY = _float("STORY_CONFIRM_DELAY", 0.25)
...
TARGET_REFRESH_CYCLES = _int("TARGET_REFRESH_CYCLES", 3)
GROUP_MIN_MEMBERS = _int("GROUP_MIN_MEMBERS", 0)
...
AUTH_CHECK_RETRIES = _int("AUTH_CHECK_RETRIES", 5)
AUTH_CHECK_DELAY = _float("AUTH_CHECK_DELAY", 2.0)
DELETE_SESSION_ON_AUTH_FAIL = _env("DELETE_SESSION_ON_AUTH_FAIL", "0").lower() not in (
    "0",
    "false",
    "no",
    "",
)
AUTH_DELETE_AFTER = _int("AUTH_DELETE_AFTER", 2)
SESSION_AUTH_REST = _int("SESSION_AUTH_REST", 300)
SESSION_START_STAGGER_MAX = _float("SESSION_START_STAGGER_MAX", 4.0)
