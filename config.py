...
DELAY_MESSAGES = _float("DELAY_MESSAGES", 0.7)
DELAY_MESSAGES_USER = _float("DELAY_MESSAGES_USER", 0.5)
DELAY_CYCLES = _float("DELAY_CYCLES", 6)
...
PEER_FLOOD_REST = _int("PEER_FLOOD_REST", 180)
